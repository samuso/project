...
for i in range(2014, 2017):
	...
	X3 = get_variables_from_maps(airbnb_room, msoa_order, str(i))

	# airbnb zscore for houses
	X4 = get_variables_from_maps(airbnb_house, msoa_order, str(i))

	# airbnb review count zscore
	X5 = get_variables_from_maps(airbnb_review, msoa_order, str(i))
